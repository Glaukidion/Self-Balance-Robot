...
// For calibration
#define DISCARDED_MEASURES              10 //Original value 100 - Edition: Grupo 2
...
class MPU6050 {
	...
	public:
		...
		// Setup method - modified by: Grupo 2 - Inclusion of parameter uliRunTime - to avoid the use of fuction millis*/
		void Initialize (unsigned long int uliRunTime);

#ifdef ESP8266
		void Initialize (int sda, int scl);
#endif

		// Method that updates all attributes - modified by: Grupo 2 - Inclusion of parameter uliRunTime - to avoid the use of fuction millis*/
		void Execute (unsigned long int uliRunTime);
	...
	private:
		...
		/* modified by: Grupo 2 - Inclusion of parameter uliRunTime - to avoid the use of fuction millis */
		void BaseInititalize (unsigned long int uliRunTime);
};
