...
void MPU6050::Initialize (unsigned long int uliRunTime) {

	// Beginning Wire
	wire->begin();
	this->BaseInititalize(uliRunTime);
}
/*modified by: Grupo 2 - Inclusion of parameter uliRunTime - to avoid the use of fuction millis*/
void MPU6050::BaseInititalize (unsigned long int uliRunTime) {
	...
	// Beginning integration timer - Edition: Grupo 2
	intervalStart = uliRunTime;
}

/*
/*	Method that executes all readings and updates all attributes
/* 	Modified by: Grupo 2 - Inclusion of parameter uliRunTime - to avoid the use of fuction millis*/
void MPU6050::Execute (unsigned long int uliRunTime) {
	...
	dt = (uliRunTime - intervalStart) * 0.001;
